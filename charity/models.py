...
class Donation(models.Model):
    ...
    pick_up_date = models.DateField(
        validators=[tomorrow_date],
        verbose_name=_("pick up date"),
    )
    pick_up_time = models.TimeField(
        validators=[min_working_hours, max_working_hours],
    ...
    is_taken_date = models.DateField(
        blank=True,
        null=True,
    ...
    def __str__(self):
        return (
            f"Przekazanie {self.quantity} worków/a {self.categories.__str__} organizacji - \n"
