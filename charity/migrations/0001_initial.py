...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_of_submission', models.DateTimeField(auto_now_add=True, verbose_name='date of submission')),
                ...
                ('is_taken', models.BooleanField(default=False, verbose_name='picked up')),
                ('is_taken_date', models.DateField(blank=True, null=True, verbose_name='pick up confirmation date')),
                ('categories', models.ManyToManyField(to='charity.Category', verbose_name='categories')),
