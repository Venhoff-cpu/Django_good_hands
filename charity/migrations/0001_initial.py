# Generated by Django 3.1.1 on 2020-09-25 11:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pick_up_comment', models.CharField(blank=True, default='', max_length=256, verbose_name='comment')),
                ('is_taken', models.BooleanField(choices=[(True, 'Tak'), (False, 'Nie')], default=False, verbose_name='picked up')),
                ('is_taken_date', models.DateField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(limit_value=charity.models.one_day_hence, message='Data odbioru nie może być z przeszłości')], verbose_name='pick up confirmation date')),
                ('categories', models.ManyToManyField(to='charity.Category', verbose_name='categories')),
            ...
            options={
                ...
                'ordering': ['-pick_up_date', '-is_taken'],
            },
        ),
    ]
