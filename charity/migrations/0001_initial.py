# Generated by Django 3.1.1 on 2020-09-27 13:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "categories",
                    models.ManyToManyField(to="charity.Category", verbose_name="categories"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_of_submission",
                    models.DateTimeField(auto_now_add=True, verbose_name="date of submission"),
                ),
                (
                    "quantity",
                    models.IntegerField(
                ...
                (
                    ...
                    models.DateField(
                        validators=[
                            django.core.validators.MinValueValidator(
                                limit_value=charity.models.one_day_hence,
                ...
                (
                    ...
                    models.TimeField(
                        validators=[
                            django.core.validators.MinValueValidator(
                                limit_value=datetime.time(8, 0),
                                message="Odbiór można zlecić w godzinach 8:00 - 20:00",
                            ),
                            django.core.validators.MaxValueValidator(
                                limit_value=datetime.time(20, 0),
                                message="Odbiór można zlecić w godzinach 8:00 - 20:00",
                            ),
                        ],
                ...
                (
                    "pick_up_comment",
                    models.CharField(blank=True, default="", max_length=256, verbose_name="comment"),
                ),
                (
                    "is_taken",
                    models.BooleanField(default=False, verbose_name="picked up"),
                ),
                (
                    "is_taken_date",
                    models.DateField(blank=True, null=True, verbose_name="pick up confirmation date"),
                ),
                (
                    "categories",
                    models.ManyToManyField(to="charity.Category", verbose_name="categories"),
